...
[![Maven Central](https://img.shields.io/badge/Maven_Central-3.1.0-blue?logo=apachemaven)](https://central.sonatype.com/search?namespace=net.jacobpeterson.jet)
[![Gradle Plugin](https://img.shields.io/badge/Gradle_Plugin-3.1.0-blue?logo=gradle)](https://plugins.gradle.org/plugin/net.jacobpeterson.jet.openapiannotationsplugin)
[![Javadoc](https://img.shields.io/badge/javadoc-3.1.0-brightgreen)](https://javadoc.io/doc/net.jacobpeterson.jet)
...
```kotlin
dependencies {
    implementation("net.jacobpeterson.jet:server:3.1.0")
}
```
...
```kotlin
dependencies {
    implementation("net.jacobpeterson.jet:openapi-annotations:3.1.0")
}
```
...
```kotlin
plugins {
    id("net.jacobpeterson.jet.openapiannotationsplugin") version "3.1.0"
}
```
...
```kotlin
dependencies {
    implementation("net.jacobpeterson.jet:client:3.1.0")
}
```
...
```kotlin
dependencies {
    implementation("net.jacobpeterson.jet:common:3.1.0")
}
```
