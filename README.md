...
[![Maven Central](https://img.shields.io/badge/Maven_Central-1.0.2-blue?logo=apachemaven)](https://central.sonatype.com/search?namespace=net.jacobpeterson.jet)
[![Gradle Plugin](https://img.shields.io/badge/Gradle_Plugin-1.0.2-blue?logo=gradle)](https://plugins.gradle.org/plugin/net.jacobpeterson.jet.openapiannotationsplugin)
[![Javadoc](https://img.shields.io/badge/javadoc-1.0.2-brightgreen)](https://javadoc.io/doc/net.jacobpeterson.jet)
...
```kotlin
dependencies {
    implementation("net.jacobpeterson.jet:server:1.0.2")
}
```
...
```kotlin
dependencies {
    implementation("net.jacobpeterson.jet:openapi-annotations:1.0.2")
}
```
...
```kotlin
plugins {
    id("net.jacobpeterson.jet.openapiannotationsplugin") version "1.0.2"
}
```
...
```kotlin
dependencies {
    implementation("net.jacobpeterson.jet:client:1.0.2")
}
```
...
```kotlin
dependencies {
    implementation("net.jacobpeterson.jet:common:1.0.2")
}
```
