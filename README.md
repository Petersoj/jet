...
[![Maven Central](https://img.shields.io/badge/Maven_Central-2.0.0-blue?logo=apachemaven)](https://central.sonatype.com/search?namespace=net.jacobpeterson.jet)
[![Gradle Plugin](https://img.shields.io/badge/Gradle_Plugin-2.0.0-blue?logo=gradle)](https://plugins.gradle.org/plugin/net.jacobpeterson.jet.openapiannotationsplugin)
[![Javadoc](https://img.shields.io/badge/javadoc-2.0.0-brightgreen)](https://javadoc.io/doc/net.jacobpeterson.jet)
...
```kotlin
dependencies {
    implementation("net.jacobpeterson.jet:server:2.0.0")
}
```
...
```kotlin
dependencies {
    implementation("net.jacobpeterson.jet:openapi-annotations:2.0.0")
}
```
...
```kotlin
plugins {
    id("net.jacobpeterson.jet.openapiannotationsplugin") version "2.0.0"
}
```
...
```kotlin
dependencies {
    implementation("net.jacobpeterson.jet:client:2.0.0")
}
```
...
```kotlin
dependencies {
    implementation("net.jacobpeterson.jet:common:2.0.0")
}
```
