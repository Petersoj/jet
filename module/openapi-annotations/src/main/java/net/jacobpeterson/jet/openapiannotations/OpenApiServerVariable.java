...
public @interface OpenApiServerVariable {
    ...
    /**
     * {@link OpenApiServerVariable} raw JSON object {@link String}, merged with the existing JSON object created
     * from the serialization of this {@link Annotation}.
     */
