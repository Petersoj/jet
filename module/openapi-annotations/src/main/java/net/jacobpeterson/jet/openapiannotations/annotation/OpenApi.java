...
public @interface OpenApi {
    ...
    /**
     * {@link RepeatableAnnotation} is an annotation for {@link OpenApi} {@link Repeatable}.
     */
    @Target({TYPE, METHOD})
     ...
     * should belong to.
     * <p>
     * Note: {@link OpenApiAnnotationsProcessor} will use
     * {@link OpenApiAnnotationsProcessor#DEFAULT_ANNOTATION_GROUP_NAME} by default.
     */
    @AnnotationJsonIgnore
    String annotationGroupName() default "";

    /**
     * The {@link AnnotationOutputValidation}.
     * <p>
     * Note: {@link OpenApiAnnotationsProcessor} will use
     * {@link OpenApiAnnotationsProcessor#DEFAULT_ANNOTATION_OUTPUT_VALIDATION} by default.
     */
    @AnnotationJsonIgnore
    @AnnotationArrayIsNullableValue
    AnnotationOutputValidation[] annotationOutputValidation() default {};

    /**
     * {@link AnnotationOutputValidation} is an enum to configure the validation of the OpenAPI specification JSON
     * output generated by {@link OpenApiAnnotationsProcessor} from {@link OpenApi} annotations.
     */
    enum AnnotationOutputValidation {
     ...
     * <p>
     * Note: {@link OpenApiAnnotationsProcessor} will use
     * {@link OpenApiAnnotationsProcessor#DEFAULT_SCHEMA} by default.
     */
     ...
     * <p>
     * Note: {@link OpenApiAnnotationsProcessor} will use
     * {@link OpenApiAnnotationsProcessor#DEFAULT_OPENAPI} by default.
     *
