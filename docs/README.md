...
<div align="center">
    ...
    <img src="https://img.shields.io/badge/Maven_Central-3.5.0-blue?logo=apachemaven" alt="Maven Central"></a>
    <a href="https://plugins.gradle.org/plugin/net.jacobpeterson.jet.openapiannotationsplugin">
    <img src="https://img.shields.io/badge/Gradle_Plugin-3.5.0-blue?logo=gradle" alt="Gradle Plugin"></a>
    <a href="https://javadoc.io/doc/net.jacobpeterson.jet">
    <img src="https://img.shields.io/badge/javadoc-3.5.0-brightgreen" alt="javadoc"></a>
    <br>
...
```kotlin
dependencies {
    implementation("net.jacobpeterson.jet:common:3.5.0")
}
```
...
```kotlin
dependencies {
    implementation("net.jacobpeterson.jet:server:3.5.0")
}
```
...
```kotlin
dependencies {
    implementation("net.jacobpeterson.jet:openapi-annotations:3.5.0")
}
```
...
```kotlin
plugins {
    id("net.jacobpeterson.jet.openapiannotationsplugin") version "3.5.0"
}
```
